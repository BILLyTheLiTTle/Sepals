...
public class ShowcaseView extends RelativeLayout implements
            ...
            public void run() {
                ...
                switch (itemType) {
                    ...
                    case ITEM_ACTION_OVERFLOW:
                        ...
                        // This check essentially checks if we are on a device
                        // with
                        // a legacy menu key
                        if (overflow != null) {
     ...
     * @param absoluteCoordinates If true, this will use absolute coordinates
     *            instead of coordinates relative to the center of the showcased
     *            view
     */
